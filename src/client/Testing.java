...
public class Testing extends Thread{
	...
	public static void main(String[] args) throws MalformedURLException, IOException, InterruptedException, IOException_Exception, InterruptedException_Exception {
	...
	public void create() throws IOException, IOException_Exception {
	...
	public void signin() throws IOException, IOException_Exception {
		conObj = createObject("182.123.123.123");
		System.out.println("Method : playerSignIn() , " + conObj.playerSignIn("testuserdata1", "testuserdata1", "182.123.123.123"));
	}
	
	public void getplayerstatus() throws IOException, IOException_Exception {
		conObj = createObject("182.123.123.123");
		System.out.println("Method : getPlayerStatus() , " + conObj.getPlayerStatus("Admin", "Admin", "182.123.123.123"));
	}
	
	public void signout() throws IOException, InterruptedException, IOException_Exception, InterruptedException_Exception {
		conObj = createObject("182.123.123.123");
		System.out.println("Method : playerSignOut() , " + conObj.playerSignOut("testuserdata1", "182.123.123.123"));
	}
	
	public void transferaccount() throws IOException, InterruptedException, IOException_Exception, InterruptedException_Exception {
		conObj = createObject("182.123.123.123");
	...
	public void signinagain() throws IOException, IOException_Exception {
	...
	public void getplayerstatusagain() throws IOException, IOException_Exception {
		conObj = createObject("93.123.123.123");
		System.out.println("Method : getPlayerStatus() , " + conObj.getPlayerStatus("Admin", "Admin", "93.123.123.123"));
	}
	
	public void suspendaccount() throws IOException, IOException_Exception {
		conObj = createObject("93.123.123.123");
